...
# ============================================================
# 测站真实坐标 (来源: CAPQuake REAL_COORDS)
# 仅包含 ObsPoints.json 中有瓦片像素位置的 S-Net 海底测站
# ============================================================
...
_SNET_TILE_POSITIONS: dict[str, dict[str, tuple[int, int]]] = {
    "y11": {
        "N.S6N05": (241, 242), "N.S6N04": (253, 233), "N.S6N03": (254, 220),
        "N.S6N02": (251, 206), "N.S6N01": (250, 198), "N.S5N01": (243, 199),
        "N.S5N02": (237, 203), "N.S5N03": (230, 208), "N.S5N04": (231, 216),
        "N.S5N05": (237, 220), "N.S5N06": (242, 226), "N.S5N07": (239, 233),
        "N.S5N08": (232, 238), "N.S5N09": (224, 238), "N.S5N10": (220, 234),
        "N.S5N11": (220, 225), "N.S5N12": (219, 220), "N.S5N13": (212, 224),
        "N.S5N14": (209, 231), "N.S5N15": (207, 238), "N.S5N16": (200, 241),
        "N.S5N17": (192, 242), "N.S5N18": (184, 240), "N.S5N19": (178, 236),
        "N.S5N20": (170, 235), "N.S5N21": (164, 240), "N.S5N22": (160, 248),
        "N.S5N23": (156, 255), "N.S4N03": (169, 253), "N.S4N04": (176, 251),
        "N.S4N05": (184, 253), "N.S4N06": (192, 254),
    },
    "y12": {
        "N.S4N01": (154, 3), "N.S4N02": (162, 0), "N.S4N07": (199, 1),
        "N.S4N08": (207, 3), "N.S4N09": (208, 11), "N.S4N10": (202, 15),
        "N.S4N11": (194, 15), "N.S4N12": (186, 14), "N.S4N13": (181, 13),
        "N.S4N14": (173, 10), "N.S4N15": (165, 10), "N.S4N16": (165, 17),
        "N.S4N17": (168, 24), "N.S4N18": (173, 24), "N.S4N19": (181, 24),
        "N.S4N20": (189, 25), "N.S4N21": (197, 24), "N.S4N22": (203, 26),
        "N.S4N23": (202, 34), "N.S4N24": (198, 38), "N.S4N25": (190, 37),
        "N.S4N26": (182, 35), "N.S4N27": (174, 35), "N.S4N28": (166, 35),
        "N.S3N01": (170, 43), "N.S3N02": (176, 46), "N.S3N03": (184, 47),
        "N.S3N04": (192, 48), "N.S3N05": (199, 50), "N.S3N06": (203, 56),
        "N.S3N07": (200, 62), "N.S3N08": (192, 63), "N.S3N09": (185, 64),
        "N.S3N10": (178, 61), "N.S3N11": (170, 59), "N.S3N12": (163, 62),
        "N.S3N13": (163, 69), "N.S3N14": (171, 71), "N.S3N15": (178, 73),
        "N.S3N16": (185, 73), "N.S3N17": (193, 74), "N.S3N18": (200, 77),
        "N.S3N19": (199, 84), "N.S3N20": (194, 88), "N.S3N21": (188, 87),
        "N.S3N22": (180, 86), "N.S3N23": (172, 85), "N.S3N24": (164, 84),
        "N.S3N25": (156, 82), "N.S3N26": (149, 82), "N.S2N01": (145, 90),
        "N.S2N02": (151, 94), "N.S2N03": (159, 94), "N.S2N04": (165, 95),
        "N.S2N05": (173, 98), "N.S2N06": (180, 101), "N.S2N07": (186, 103),
        "N.S2N08": (183, 109), "N.S2N09": (178, 113), "N.S2N10": (170, 112),
        "N.S2N11": (163, 110), "N.S2N12": (156, 108), "N.S2N13": (150, 106),
        "N.S2N14": (145, 112), "N.S2N15": (144, 120), "N.S2N16": (149, 125),
        "N.S2N17": (155, 126), "N.S2N18": (162, 124), "N.S2N19": (169, 126),
        "N.S2N20": (173, 133), "N.S2N21": (172, 138), "N.S2N22": (169, 145),
        "N.S2N23": (162, 144), "N.S2N24": (154, 143), "N.S2N25": (148, 141),
        "N.S2N26": (140, 140), "N.S1N01": (136, 147), "N.S1N02": (145, 148),
        "N.S1N03": (151, 151), "N.S1N04": (156, 155), "N.S1N05": (160, 160),
        "N.S1N06": (156, 165), "N.S1N07": (150, 164), "N.S1N08": (145, 159),
        "N.S1N09": (142, 165), "N.S1N10": (140, 169), "N.S1N11": (134, 168),
        "N.S1N12": (131, 171), "N.S1N13": (134, 174), "N.S1N14": (137, 181),
        "N.S1N15": (144, 184), "N.S1N16": (149, 189), "N.S1N17": (144, 193),
        "N.S1N18": (136, 191), "N.S1N19": (130, 192), "N.S1N20": (122, 191),
        "N.S1N21": (117, 187), "N.S1N22": (115, 181), "N.ST1H": (111, 183),
        "N.ST2H": (110, 178), "N.ST3H": (105, 177), "N.ST4H": (103, 175),
        "N.ST5H": (100, 173), "N.ST6H": (99, 171), "N.S6N25": (109, 181),
        "N.S6N24": (112, 193), "N.S6N23": (124, 200), "N.S6N22": (139, 203),
        "N.S6N21": (153, 200), "N.S6N20": (164, 191), "N.S6N19": (171, 179),
        "N.S6N18": (174, 166), "N.S6N17": (181, 152), "N.S6N16": (188, 140),
        "N.S6N15": (195, 127), "N.S6N14": (203, 114), "N.S6N13": (209, 101),
        "N.S6N12": (212, 86), "N.S6N11": (214, 71), "N.S6N10": (218, 57),
        "N.S6N09": (221, 41), "N.S6N08": (222, 26), "N.S6N07": (225, 11),
        "N.S6N06": (235, 0),
    },
}
...
def _rgb_to_shindo(r: int, g: int, b: int) -> float | None:
    ...
    if h > 0.1476:
        ...
        p = (151.4 * h**4 - 49.32 * h**3 + 6.753 * h**2
             - 2.481 * h + 0.9033)
    else:
    ...
    for tile_name, station_dict in _SNET_TILE_POSITIONS.items():
        ...
        for obs_name, (px, py) in station_dict.items():
            ...
            if shindo is None:
                continue
            stations.append({
                "name": real_name, "lat": lat, "lon": lon,
                "shindo": shindo, "rgb": (r, g, b),
                "tile": tile_name, "px": px, "py": py,
            })
    return stations


@ParserRegistry.register("snet")
@ParserRegistry.register("snet_http")
class SnetParser(BaseParser):
    """NIED S-Net 海底测站震度解析器。"""

    def __init__(self, source_id: str = "snet_http"):
        # 统一使用 snet_http 作为 source_id（与旧版一致）
        super().__init__("snet_http")

    def parse(self, raw: Any) -> list[EventEnvelope] | None:
        """解析 S-Net 瓦片数据，返回事件列表。
        ...
        min_shindo = float(raw.get("min_shindo", -99))
        ...
        sorted_stations = sorted(all_stations, key=lambda s: s["shindo"], reverse=True)
        triggered = [s for s in sorted_stations if s["shindo"] >= min_shindo]
        if not triggered:
            return None
        ...
        occurred_at = None
        try:
            occurred_at = datetime.strptime(timestamp, "%Y%m%d%H%M00").replace(tzinfo=timezone.utc)
        except (ValueError, TypeError):
            occurred_at = datetime.now(timezone.utc)

        max_shindo = top["shindo"]
        event = EarthquakeReport(
            source_id=self.source_id,
            event_id=f"snet_{timestamp}",
        ...
        return [EventEnvelope(
            identity=EventIdentity(
                event_id=event.event_id, source_id=self.source_id, event_type="earthquake",
            ),
            event=event,
            payload=SourcePayload(source_id=self.source_id, raw=raw),
            metadata={"stations": all_stations, "triggered": triggered},
        )]
